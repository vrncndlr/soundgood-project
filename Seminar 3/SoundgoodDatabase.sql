...
CREATE TABLE student (
 student_id SERIAL NOT NULL ON DELETE CASCADE,
 first_name VARCHAR(100) NOT NULL,
 last_name VARCHAR(100) NOT NULL,
 street VARCHAR(100) NOT NULL,
 zipcode VARCHAR(5) NOT NULL,
...
ALTER TABLE instructor_lesson ADD lesson_type VARCHAR(100);
ALTER TABLE instructor_lesson ADD time_slot TIMESTAMP;
...
ALTER TABLE ensemble_schedule ADD CONSTRAINT PK_ensemble_schedule PRIMARY KEY (id);
